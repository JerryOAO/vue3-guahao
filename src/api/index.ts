...
import type { hospitalResponseData, HospitalLevelAndRegionResponseData, HospitalInfo, HospitalDetail, DepartmentResponseData, LoginData, UserLoginResponseData } from './type'
